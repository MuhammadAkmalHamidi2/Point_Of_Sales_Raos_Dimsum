      ...
      <div className="max-w-md mx-auto px-4 py-5 space-y-5">
        ...
        <div className="space-y-2.5">
          ...
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Cari No. Invoice atau menu..."
              value={searchQuery}
              onChange={(e) => setSearchQuery(e.target.value)}
              className="w-full h-10 bg-white border border-zinc-200 rounded-xl pl-10 pr-4 text-xs font-medium text-zinc-800 placeholder:text-zinc-400 outline-none focus:border-[#E52424] focus:ring-2 focus:ring-[#E52424]/10 transition shadow-xs"
            />
          </div>
